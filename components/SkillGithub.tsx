...
import html from '../assets/github-mark-white.svg'

type Props = {
    directionLeft?: boolean;
}

function SkillGithub({directionLeft}: Props) {
  return (
    ...
    <p className='text-3xl bold text-black opacity-100'>40%</p>
      </div>
    </div>
    </div>
  )
